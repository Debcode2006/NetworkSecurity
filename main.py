...
from networksecurity.entity.config_entity import DataIngestConfig, TrainingPipelineConfig, DataValidationConfig, DataTransformationConfig, ModelTrainerConfig
